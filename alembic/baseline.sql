-- ⚠️ FROZEN ALEMBIC BASELINE — DO NOT EDIT.
-- The immutable starting-point schema applied by the `baseline` revision
-- (alembic/versions/0001_baseline.py). Every change AFTER this is a NEW Alembic
-- revision (`task db:revision -- "msg"`), never an edit here. A CI gate fails if
-- this file changes without a new revision. See Decisions.md (Alembic adoption).
-- Idempotent (all CREATE ... IF NOT EXISTS) → re-applying to a populated DB no-ops.
...
CREATE TABLE IF NOT EXISTS memory_timeline (
    ...
    summary TEXT,
    embedding vector(1024),  -- bge-m3 uses 1024 dims
