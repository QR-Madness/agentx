...
- **Settings you can navigate** — search now finds individual settings, not just section names, and jumps straight to the control. A new Overview lists what you've changed from the defaults and offers to put it back; **Memory → Recall** explains every knob and when to move it.
