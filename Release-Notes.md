...
- **Settings you can navigate** — search now finds individual settings, not just section names, and jumps straight to the control. A new Overview lists what you've changed from the defaults and offers to put it back; **Recall** and **Conversation Context** explain every knob and when to move it.
...
- **Settings → Web Search is the control plane** — defaults, per-turn budgets in *calls and dollars*, and a **source policy** of preferred/blocked domains.
