...
### **[📚 Read the Docs →](https://agentx.thejpnet.net/docs)**
...
> Everything else — setup, architecture, configuration, and API reference — lives in the **[docs](https://agentx.thejpnet.net/docs)**.
