...
// ── Hero: the AgX Team multi-agent trace ───────────────────────────────────
...
export const ALLOY: AlloyAgent[] = [
  { role: 'planner', id: 'swift-lucid-mole', color: 'var(--c-agent)' },
  { role: 'researcher', id: 'quiet-amber-fox', color: 'var(--c-memory)' },
  { role: 'writer', id: 'brisk-cobalt-otter', color: 'var(--c-drafting)' },
];

export type TraceLine = { t: string; r: string; k: string; l: string; m: string };

// A curated trace — a handful of legible beats, not a full firehose. Each line
// is one plain-language step so the hero reads as "watch it think", not a log dump.
export const TRACE: TraceLine[] = [
  { t: '+000', r: 'planner', k: 'req', l: 'POST /agent/run', m: '"draft the Q2 roadmap brief"' },
  { t: '+019', r: 'planner', k: 'memory', l: 'recall', m: '6 memories · self + global' },
  { t: '+044', r: 'planner', k: 'team', l: 'delegate', m: '→ researcher, writer' },
  { t: '+089', r: 'researcher', k: 'tool', l: 'github', m: '14 open issues' },
  { t: '+498', r: 'researcher', k: 'reason', l: 'ReAct', m: '8 thoughts → 5 issues' },
  { t: '+1.3', r: 'planner', k: 'merge', l: 'AgentResult', m: '3 agents · 4 tools · 1.3s' },
];
